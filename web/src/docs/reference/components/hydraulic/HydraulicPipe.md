...
re &= \text{reynolds}\left(rho, \left|v\right| + 1.0E-9, d, rho\cdot nu\right) \\
f &= \text{friction\_factor}\left(re, \frac{rough}{d}\right) \\
out.p &= in.p - \frac{f\cdot \frac{l}{d}\cdot rho\cdot v\cdot \left|v\right|}{2}
\end{aligned}
$$
