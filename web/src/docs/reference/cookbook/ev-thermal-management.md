...
### Verified example — EV Thermal Management System
...
{ CHECK A_bcp 0.45 4.4999999999999993e-7 }
{ CHECK A_cab 0.032 3.2e-8 }
{ CHECK A_chl_c 0.36 3.599999999999999e-7 }
```
