...
name: cancel
category: CAS (REPL)
summary: Symbolic cancel (REPL-only Rust CAS operation).
related: []
examples: []
...
Symbolic computer-algebra operation **cancel**, available in the REPL terminal (Rust CAS backend; solve a document first).
