...
name: simplify
category: CAS (REPL)
summary: Symbolic simplify (REPL-only Rust CAS operation).
related: []
examples: []
...
Symbolic computer-algebra operation **simplify**, available in the REPL terminal (Rust CAS backend; solve a document first).
