...
`ttest_paired_stat` is available in the frees built-in functions surface.
...
```frees
result = ttest_paired_stat([9, 10, 11, 12, 10], [10, 10, 12, 14, 13])

{ CHECK result -2.745625892 0.000002745625891934576 }
```
