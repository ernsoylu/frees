...
- **Phase R / §8.5 automatic variable scaling** (findings 4–5) — now the top blocker: unblocks both real-fluid networks and derived-property boundaries. Domain-aware nominal guesses (P~10⁵, h~10⁵, ṁ~1) + row/column equilibration in the Newton step.
