...
8. **Control Systems:** industry-standard-style LTI modeling (TF, SS, ZPK), frequency responses (Bode, Nyquist), and controller synthesis (LQR, PID).
