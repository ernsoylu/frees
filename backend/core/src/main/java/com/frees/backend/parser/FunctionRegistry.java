...
public class FunctionRegistry {
    ...
    private static final List<FunctionInfo> FUNCTIONS = List.of(
            ...
            new FunctionInfo("htc_cond", "htc_cond(fluid$, P, x, mdot, Dh, Aflow)", "HEAT h [W/m^2/K], Shah condensation correlation. SIDE: condensing two-phase refrigerant. HX: condenser/gas-cooler refrigerant side", "Heat Transfer"),
            ...
            new FunctionInfo("dp_compact_core", "dp_compact_core(G, rho_in, rho_out, rho_mean, sigma, f, AoverAc, Kc, Ke)", "dP [Pa], compact-core method (entrance/accel/core-friction/exit). SIDE: air/gas through a compact finned core. HX: fin-and-tube/plate-fin radiator, condenser, CAC air side", "Heat Transfer"),
