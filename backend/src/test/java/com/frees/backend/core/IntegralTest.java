...
class IntegralTest {
    ...
    void solvesIntegralNestedInExpression() {
        // As in a reference solver, Integral may appear inside an expression: the nested
    ...
    void solvesVariableUpperLimit() {
        ...
        // from the default guess 1); t lands on the upper limit, as in a reference solver.
        EquationSystemSolver.Result result =
