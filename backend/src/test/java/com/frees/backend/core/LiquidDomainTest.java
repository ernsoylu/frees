...
class LiquidDomainTest {
    ...
    void splitLibraryLoadsAllDomainsIncludingLiquid() {
        ...
        // + 7 C/R + moving-boundary + (P,h) source (T3) + 6 AC (Chiller/AirCoil/EXV/TXV
        // + LiquidWallHX/MoistAirWallHX)
        assertEquals(122, names.size(), "built-in component count after the per-domain split");
