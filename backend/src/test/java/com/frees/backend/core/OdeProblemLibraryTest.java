...
/**
 * A library of 20 classic engineering-physics ODE problems (sourced from the a reference solver
 * Clone research corpus — a reference solver manual / the standard methodology text / the standard literature) solved through
