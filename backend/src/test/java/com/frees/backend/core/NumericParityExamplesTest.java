 ...
 * answers (the kind of analysis a numeric package and a reference solver are used for).
 */
class NumericParityExamplesTest {
    ...
    /**
     * the standard methodology text (Klein &amp; the standard literature), Table 2-1 thermal-conductivity curve fit.
