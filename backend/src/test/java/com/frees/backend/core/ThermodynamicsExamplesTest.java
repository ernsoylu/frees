...
/**
 * Known engineering problems from a standard thermodynamics text, "Thermodynamics: An
...
class ThermodynamicsExamplesTest {
    ...
    void example1_1_windTurbineEnergyAndSavings() {
        ...
        EquationSystemSolver.Result result = solver.solve("""
                { a standard thermodynamics text Example 1-1 }
    ...
    void example1_2_oilTankMass() {
        EquationSystemSolver.Result result = solver.solve("""
                { a standard thermodynamics text Example 1-2 }
    ...
    void example1_9_manometerAbsolutePressure() {
        ...
        EquationSystemSolver.Result result = solver.solve("""
                { a standard thermodynamics text Example 1-9 }
