...
/**
 * Worked examples from a standard thermodynamics text, "Thermodynamics: An Engineering
 * Approach" (9th ed., ch. 3), solved as frEES equation systems against
 * CoolProp. All values SI: K, Pa, J/kg, m3/kg.
 *
 * Note: the book's R134a tables use the industry-handbook reference state while
