 ...
 * the dissociation-corrected value (~2225 K for stoichiometric CH4, the standard literature).
 */
class EquilibriumTransportTest {
    ...
    void equilibriumConstantMatchesJanafTable() {
        // CO2 = CO + 1/2 O2, ln Kp from the standard literature Table A-28 (index 0).
