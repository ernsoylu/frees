 ...
 * cross-checked against the standard literature, Thermodynamics (complete combustion, no
 * dissociation) via the research corpus: CH4/stoich ~2328 K, CH4/200% air ~1481 K,
...
class CombustionThermoTest {
    ...
    void adiabaticFlameTemperatureMethane() {
        ...
        // 150% theoretical air -> phi = 1/1.5; the standard literature Example 15-10 = 1789 K.
    ...
    void adiabaticFlameTemperatureOctaneViaJanafFallback() {
        ...
        // the standard literature Example 15-8 (liquid octane, stoichiometric): 2395 K.
