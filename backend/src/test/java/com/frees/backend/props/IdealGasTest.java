 ...
 * 1 atm enthalpy-of-formation reference (the standard literature A-2c polynomials, A-26
 * formation data). Reference values from the the standard literature ideal-gas tables.
 */
class IdealGasTest {
    ...
    void sensibleEnthalpyMatchesIdealGasTables() {
        // the standard literature A-18: h(N2, 1000 K) - h(N2, 298 K) = 30,129 - 8,669 kJ/kmol.
        double dh = eval("prop$enthalpy$n2$t", 1000.0)
                - eval("prop$enthalpy$n2$t", 298.15);
        assertEquals(21_460.0 / 28.013 * 1000.0, dh, 3000.0);

        // the standard literature A-20: h(CO2, 1000 K) - h(CO2, 298 K) = 42,769 - 9,364 kJ/kmol.
