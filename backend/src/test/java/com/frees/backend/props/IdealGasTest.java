...
class IdealGasTest {
    ...
    void realFluidGibbsAndCompressibility() {
        ...
        // From the standard literature Example 3-12: Z should be around 0.84
    ...
    void stagnationProperties() {
        // the standard literature Example 17-1: Air entering diffuser at T = 300 K, P = 100 kPa with V = 200 m/s.
