 ...
 * (the standard literature Table 11.3/11.4; the standard literature &amp; London), cross-checked via the research corpus
 * against the standard literature &amp; London and the standard literature. NTU = 1, Cr = 0.5 unless noted.
 */
