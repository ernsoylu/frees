 ...
 * Polynomial coefficients are represented as double arrays in descending powers (industry-standard-style).
 */
public final class PolynomialHelpers {
    ...
    /** Partial-fraction residues, poles, and direct term (a matrix language residue order). */
