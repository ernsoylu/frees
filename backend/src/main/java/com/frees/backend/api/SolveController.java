...
public class SolveController {
     ...
     * (the display-only conversion model). The recorded unit (declared or derived) is
    ...
    public ResponseEntity<CheckResponse> check(@RequestBody SolveRequest request) {
        ...
        try {
            ...
            // a reference solver halts at the first syntax error; report the first one found.
    ...
    public ResponseEntity<SolveResponse> solve(@RequestBody SolveRequest request) {
        ...
        try {
            ...
            // a reference solver checks units automatically after calculations finish.
