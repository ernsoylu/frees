...
public class WarmupListener {
    ...
    public WarmupListener(SolveController solveController, org.springframework.beans.factory.ObjectProvider<ComputeDispatcher> dispatcherProvider) {
    ...
    public void warmup() {
        ...
        try {
            ...
            // Warm up RabbitMQ connection lazily established in ComputeDispatcher
            if (computeDispatcher != null) {
                // dispatch a dummy solve to a fake session
                computeDispatcher.dispatch("WARMUP", "warmup", request);
            }
