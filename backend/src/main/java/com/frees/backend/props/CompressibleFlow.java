 ...
 * (an open-source gas-dynamics kit {@code idealgasflow.d}) and the Compressible-Flow function library in
 * a reference solver, and were cross-checked against the standard literature, <i>Thermodynamics: An Engineering
