...
/**
 * a reference solver ideal-gas property functions: spelled chemical formulas (N2, CO2, ...)
 ...
 *
 * Specific heats use the cubic fits of the standard literature Table A-2(c),
...
public final class IdealGas {
     ...
     * entropy s0 [kJ/kmol-K] at 298.15 K / 1 atm (the standard literature A-26), and the
     * cp(T) cubic coefficients [kJ/kmol-K] (the standard literature A-2c).
     */
