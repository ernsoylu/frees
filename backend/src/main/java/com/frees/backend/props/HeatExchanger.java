 ...
 * forms from the standard literature &amp; London, <i>Compact Heat Exchangers</i>, and the standard literature,
 * <i>Heat Exchangers: Selection, Rating and Thermal Design</i> (cross-checked
 * via the research corpus against those texts and the handbook reference handbook).
 *
