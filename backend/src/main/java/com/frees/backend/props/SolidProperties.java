 ...
 * a reference solver-style material functions {@code k_}, {@code rho_}, {@code c_}, {@code E_},
 * and {@code nu_}. Values are representative room-temperature figures from
 * standard references (the standard literature, the standard literature); they are treated as constants — the
...
public final class SolidProperties {
    ...
    // Fits to standard tabulated data (the standard literature) over roughly 250-600 K. Only
