...
public class FunctionRegistry {
    ...
    private static final List<FunctionInfo> FUNCTIONS = List.of(
            ...
            new FunctionInfo("dp_compact_core", "dp_compact_core(G, rho_in, rho_out, sigma, Kc, Ke)", "Compact-core pressure drop [Pa] (compact-HX entrance/accel/exit)", "Heat Transfer"),
