...
public class FunctionRegistry {
    ...
    private static final List<FunctionInfo> FUNCTIONS = List.of(
            ...
            new FunctionInfo("dp_compact_core", "dp_compact_core(G, rho_in, rho_out, rho_mean, sigma, f, AoverAc, Kc, Ke)", "dP [Pa], compact-HX core (entrance/accel/core-friction/exit). SIDE: air/gas through a compact finned core. HX: fin-and-tube/plate-fin radiator, condenser, CAC air side", "Heat Transfer"),
