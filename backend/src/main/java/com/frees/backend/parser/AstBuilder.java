...
public class AstBuilder extends FreesBaseVisitor<Expr> {
     ...
     * (callable inline in expressions). The industry-standard-style multi-output form
    ...
    /**
     * industry-standard-style range that fills an array: {@code speed = 0:10:100 | Linear}.
    ...
    /**
     * industry-standard-style destructuring call {@code [q, w] = split(x)} of a multi-output
     ...
     * industry-standard-style element-wise operators (which are two characters). */
