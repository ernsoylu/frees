...
public class AstBuilder extends FreesBaseVisitor<Expr> {
    ...
    public Expr visitCallAtom(FreesParser.CallAtomContext ctx) {
        ...
        // a reference solver Convert(From, To): the arguments are unit expressions, not math.
        ...
        // a reference solver ConvertTemp(From, To, x): affine temperature conversion (the
        // only a reference solver conversion with an offset). Folds to a*x + b.
