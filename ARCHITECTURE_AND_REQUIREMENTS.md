...
- **Preferences (Stop Criteria)** — the four a reference solver stop criteria (no. iterations 250, relative residuals 1e-6, change in variables 1e-9, elapsed time 3600 s), configurable per solve via a Preferences modal and persisted client-side.
