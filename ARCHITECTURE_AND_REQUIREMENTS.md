...
- **Milestone 9:** *Working software capable of solving transient heat-conduction models, executing bitwise logic calculations, fitting model curves to experimental datasets via least-squares, and visualizing solver data using 3D surface graphs and multi-series bar charts.*
