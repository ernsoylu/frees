// The document a fresh workspace boots with (also EXAMPLES[0] in the example
// catalog). Lives in its own module so App.tsx doesn't drag the whole 58 KB
// example catalog into the entry chunk — the catalog is lazy-loaded with the
// Open Example modal.

export const DEFAULT_EXAMPLE_TEXT = `// EV Thermal Management System  (coupled, geometry-driven HX sizing)
