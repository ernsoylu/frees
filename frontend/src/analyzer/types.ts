// Data Analyzer model (MDA-like measurement analysis, todo.md Phase 1).
//
...
export interface AnalyzerSignal extends SignalRef {
  color: string
  /** Rendering override (MDA "Treat As Boolean/Analog Signal"); absent = auto. */
...
export interface AnalyzerStrip {
   ...
   * resize handle rebalances the shares (MDA strip layout).
   */
  weight?: number
}
