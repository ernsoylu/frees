...
const CENGEL_EXAMPLES = [
  {
    value: "textbook-10-40",
    title: "Power Cycles: Reheat Rankine Cycle with Moisture Limit (the standard literature 10-40)",
    ...
    code: `{ Reheat Rankine Cycle - the standard literature 10-40 }
...
eta_th = w_net / q_in * 100`,
  ...
  {
    value: "textbook-10-62e",
    title: "Power Cycles: Ideal Reheat-Regenerative Rankine Cycle, English Units (the standard literature 10-62E)",
    ...
    code: `{ Ideal Reheat-Regenerative Rankine Cycle - the standard literature 10-62E }
...
eta_th = w_net / q_in * 100`,
  ...
  {
    value: "textbook-10-78",
    title: "Power Cycles: Cogeneration Plant with Regeneration (the standard literature 10-78)",
    ...
    code: `{ Cogeneration Plant with Regeneration - the standard literature 10-78 }
...
Q_dot_process = m_dot * (f_ext - y) * (h[7] - h[3])`,
  ...
  {
    value: "textbook-10-28",
    title: "Power Cycles: Binary Geothermal Plant with Isobutane (the standard literature 10-28)",
    ...
    code: `{ Binary Geothermal Power Plant with Isobutane - the standard literature 10-28 }
...
eta_th = W_dot_net / Q_dot_in * 100`,
  ...
  {
    value: "textbook-9-95",
    title: "Gas Turbines: Simple Brayton Cycle with Irreversibilities (the standard literature 9-95)",
    ...
    code: `{ Simple Brayton Cycle with Irreversibilities - the standard literature 9-95 }
...
eta_th = w_net / q_in * 100`,
  ...
  {
    value: "textbook-9-105",
    title: "Gas Turbines: Automotive Gas Turbine with Regenerator (the standard literature 9-105)",
    ...
    code: `{ Automotive Gas Turbine with Regenerator - the standard literature 9-105 }
...
Q_dot_out = Q_dot_in - W_dot_net`,
  ...
  {
    value: "textbook-9-112",
    title: "Gas Turbines: Brayton Cycle with Regeneration and Variable Specific Heats (the standard literature 9-112)",
    ...
    code: `{ Brayton Cycle with Regeneration, Variable Specific Heats - the standard literature 9-112 }
        ...
        return (
          <Stack gap="md">
            ...
            <Text size="md" style={{ lineHeight: 1.6 }}>
              Welcome to <strong>frEES</strong> (free the reference equation solver). frEES is a declarative, web-based numerical solver designed for engineers, researchers, and students.
            </Text>
            <Text size="md" style={{ lineHeight: 1.6 }}>
              Unlike procedural languages (like Python, a matrix language, or C++), where you must explicitly rearrange equations to solve for unknowns (e.g. writing <code>x = ...</code>), frEES is <strong>declarative</strong>. You input your equations exactly as they are written in physics and engineering textbooks (e.g. <code>P * V = n * R * T</code>), and the solver automatically determines which variables are unknown, groups equations into blocks, and solves them simultaneously.
            </Text>
        ...
        return (
          <Stack gap="md">
            ...
            <Text style={{ lineHeight: 1.6 }}>
              ...
              convention that makes combustion energy balances work directly (a reference solver behavior).
            ...
            <Text size="sm" style={{ lineHeight: 1.6 }}>
              ...
              Specific heats use the the standard literature A-2(c) polynomial fits, valid through flame
