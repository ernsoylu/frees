      ...
      case 'syntax':
        return (
          <Stack gap="md">
            ...
            <Text style={{ lineHeight: 1.6 }}>
              A variable whose name ends in <Code>$</Code> is a <strong>string variable</strong> (a reference solver
      ...
      case 'arrays':
        return (
          <Stack gap="md">
            ...
            <Title order={3} mt="sm">Range Generation (industry-standard-style)</Title>
            <Text>
