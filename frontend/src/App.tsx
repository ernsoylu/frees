    ...
    try {
      ...
      setVarDrafts((drafts) => {
        ...
        for (const name of response.variables) {
          ...
          // a reference solver assigns units to a variable set from an annotated constant
      ...
      <Group justify="space-between">
        <Group gap="sm" align="baseline">
          ...
          <Text c="dimmed" size="sm">
            free the reference equation solver
          </Text>
        </Group>
        <Group gap="xs">
            ...
            <Stack gap="sm">
              ...
              {result.success && result.unitWarnings.length > 0 && (
                <Alert
                  ...
                  variant="light"
                  p="xs"
                  title="Unit consistency warnings (a reference solver Check Units)"
                >
                  <Stack gap={2}>
