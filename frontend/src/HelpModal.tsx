      ...
      <Tabs defaultValue="started" color="blue" variant="outline">
        ...
        <Tabs.Panel value="started">
          <Stack gap="sm">
            ...
            <Text size="sm">
              frEES is a web-based clone of the the reference equation solver (a reference solver). Unlike standard sequential programming languages, frEES is a declarative equation solver:
            </Text>
