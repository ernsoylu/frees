...
const CATEGORY_REFS = {
  'Special Functions': ['the standard literature, M. & the standard literature, I.A., Handbook of Mathematical Functions', 'NIST Digital Library of Mathematical Functions (dlmf.nist.gov)'],
  'Stats': ['the standard literature, D.C. & the standard literature, G.C., a standard statistics text'],
  'Matrix': ['the standard literature, G.H. & the standard literature, C.F., Matrix Computations (4th ed.)'],
  'Control Systems': ['the standard literature, N.S., a standard controls text (7th ed.)', 'the standard literature, K., a standard controls text (5th ed.)'],
  'Control': ['the standard literature, N.S., a standard controls text (7th ed.)', 'the standard literature, K., a standard controls text (5th ed.)'],
  'Compressible Flow': ['the standard literature, Y.A., the standard literature, M.A. & Kanoğlu, M., a standard thermodynamics text, Ch. 17', 'Anderson, J.D., Modern Compressible Flow (3rd ed.)'],
  'Heat Transfer': ['the standard literature, F.P. et al., Fundamentals of Heat and Mass Transfer', 'the standard literature, S. et al., Heat Exchangers: Selection, Rating, and Thermal Design'],
  'Flow Networks': ['the standard literature, a standard fluids text', 'the standard literature, I.E., Handbook of Hydraulic Resistance'],
  'Pneumatics': ['ISO 6358 — Pneumatic fluid power: determination of flow-rate characteristics'],
  'Two-Phase Flow': ['the standard literature, J.G. & the standard literature, J.R., a standard two-phase text (3rd ed.)'],
  'Atmosphere': ['U.S. Standard Atmosphere, 1976 (NOAA/NASA/USAF)'],
  'Properties (EOS)': ['the standard literature, B.E., the standard literature, J.M. & O’Connell, J.P., The Properties of Gases and Liquids (5th ed.)'],
  'Combustion': ['Turns, S.R., An Introduction to Combustion (3rd ed.)', 'the standard literature, J.B., a standard engine text'],
  'Calculus': ['a standard numerics text, a standard numerics text (3rd ed.), Ch. 4'],
  'Interpolation': ['a standard numerics text, a standard numerics text (3rd ed.), Ch. 3'],
  'Fluid Properties': ['Bell, I.H. et al. (2014), Ind. Eng. Chem. Res. 53:2498 — CoolProp'],
  'Solid Materials': ['the standard literature, F.P. et al., Fundamentals of Heat and Mass Transfer, Appendix A'],
