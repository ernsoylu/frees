...
## Element-wise matrix/array operators (a matrix language parity)

Add industry-standard-style element-wise operators so matrix/array math reaches parity with
...
### Out of scope (declarative solver, not imperative a matrix language)
