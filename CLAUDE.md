...
**frEES** is a web-based, 100% functional clone of the the reference equation solver (a reference solver). It uses a Java Spring Boot backend for high-performance symbolic compiling and numerical solving, and a React/TypeScript frontend for a multi-window dashboard interface.
